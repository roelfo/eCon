...
import br.upf.JPA.controller.LoginController;
import br.upf.acessibilidade.functions;
import br.upf.controller.view.Main;
...
public class LoginPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/loginIMG.jpg"))); // NOI18N
    ...
    private void logar() {
        ...
        if (new LoginController().login(usuario, senha) == 1) {
            this.dispose();
            new Main().principal();
        } else {
            txtUser.setText("");
